...
declare namespace ContextMenu {
    abstract class AbstractEntry extends MenuElement implements Entry {
        protected className: "CtxtMenu_ContextMenu" | "CtxtMenu_Menu" | "CtxtMenu_MenuArrow" | "CtxtMenu_MenuActive" | "CtxtMenu_MenuCheck" | "CtxtMenu_MenuClose" | "CtxtMenu_MenuDisabled" | "CtxtMenu_MenuItem" | "CtxtMenu_MenuLabel" | "CtxtMenu_MenuRadioCheck" | "CtxtMenu_MenuRule" | "CtxtMenu_MousePost" | "CtxtMenu_RTL" | "CtxtMenu_Attached" | "CtxtMenu_Info" | "CtxtMenu_InfoClose" | "CtxtMenu_InfoContent" | "CtxtMenu_InfoSignature" | "CtxtMenu_InfoTitle" | "CtxtMenu_MenuFrame";
        protected role: string;
        private menu;
        private type;
        private hidden;
...
declare namespace ContextMenu {
    class ContextMenu extends AbstractMenu {
        ...
        unpostWidgets(): void;
        private move_(next);
        private parseVariable({name: name, value: value, action: action});
    }
}
declare namespace ContextMenu {
...
declare namespace ContextMenu {
    class Checkbox extends AbstractItem implements VariableItem {
        protected role: string;
        private variable;
        private span;
...
declare namespace ContextMenu {
    class Radio extends AbstractItem implements VariableItem {
        protected role: string;
        private variable;
        private span;
        static parse({content: content, variable: variable, id: id}: {
